...
import 'package:smart_house/module/home/widgets/sensor_line_chart.dart';
...
class _HistoryPageState extends State<HistoryPage> {
  ...
  final List<SensorData> data = [
    SensorData(DateTime(2025, 5, 21, 1, 2), 28, 60, 30),
    SensorData(DateTime(2025, 5, 21, 1, 3), 27.5, 61, 31),
    SensorData(DateTime(2025, 5, 21, 1, 4), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 5), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 6), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 7), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 8), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 9), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 10), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 11), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 12), 27, 62, 32),
    SensorData(DateTime(2025, 5, 21, 1, 13), 27, 62, 32),
  ...
  Future<List<SensorDay>>? fetchSensorData() async {
    ...
    final docSnapshot =
        await firestore.collection('data').doc(DateFormat('yyyy_MM_dd').format(selectedDate).toString()).get();
    print("day picked");
            ...
            children: [
              ...
              FutureBuilder<List<SensorDay>>(
                ...
                builder: (context, snapshot) {
                  ...
                  child: SizedBox(
                  height: 400,
                  child: SensorLineChartDay(data: data),
                ),
                ),
                );
                },
